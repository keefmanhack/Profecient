...
newClass.click(function(){
	...
	$("form").append("<div>");
		$("div:last").append("<input class=check type=checkbox value=true name=class[days][monday]>");
		$("div:last").append("<input class=hid type=hidden value=false name=class[days][monday]>");
		$("div:last").append("<label>Monday</label>");
		$("div:last").append("<input class=check type=checkbox value=true name=class[days][tuesday]>");
		$("div:last").append("<input class=hid type=hidden value=false name=class[days][tuesday]>");
		$("div:last").append("<label>Tuesday</label>");
		$("div:last").append("<input class=check type=checkbox value=true name=class[days][wednesday]>");
		$("div:last").append("<input class=hid type=hidden value=false name=class[days][wednesday]>");
		$("div:last").append("<label>Wednesday</label>");
		$("div:last").append("<input class=check type=checkbox value=true  name=class[days][thursday]>");
		$("div:last").append("<input class=hid type=hidden value=false  name=class[days][thursday]>");
		$("div:last").append("<label>Thursday</label>");
		$("div:last").append("<input class=check type=checkbox value=true name=class[days][friday]>");
		$("div:last").append("<input class=hid type=hidden value=false name=class[days][friday]>");
		$("div:last").append("<label>Friday</label>");
		$("div:last").append("<input class=check type=checkbox value=true name=class[days][saturday]>");
		$("div:last").append("<input class=hid type=hidden value=false name=class[days][saturday]>");
		$("div:last").append("<label>Saturday</label>");
		$("div:last").append("<input class=check type=checkbox value=true name=class[days][sunday]>");
		$("div:last").append("<input class=hid type=hidden value=false name=class[days][sunday]>");
		$("div:last").append("<label>Sunday</label>");
	$("form").append("<label>Start Time</label>");
	$("form").append("<input type=number min=1 max=12 name=class[time][startHour]>");
	$("form").append("<label>:</label>");
	$("form").append("<input type=number min=0 max=60 name=class[time][startMinute]>");
	$("form").append("<select name=class[time][startAMPM]>");
		$("select:last").append("<option value=AM>AM</option>");
		$("select:last").append("<option value=PM>PM</option>");
	$("form").append("</select>");
	$("form").append("<label>End Time</label>");
	$("form").append("<input type=number min=1 max=12 name=class[time][endHour]>");
	$("form").append("<label>:</label>");
	$("form").append("<input type=number min=0 max=60 name=class[time][endMinute]>");
	$("form").append("<select name=class[time][endAMPM]>");
		$("select:last").append("<option value=AM>AM</option>");
		$("select:last").append("<option value=PM>PM</option>");
	$("form").append("</select>");
});
